...
CREATE TABLE IF NOT EXISTS `bgu_claim` (
  ...
  `Formkind` char(50) COLLATE utf8_bin DEFAULT NULL,
  `SemStatus` char(20) COLLATE utf8_bin DEFAULT NULL,
  `SemText` char(20) COLLATE utf8_bin DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `bgu_claimdetail` (
  ...
  `Accumulate` int(11) DEFAULT NULL,
  `Surplus` int(11) DEFAULT NULL,
  `SemStatus` char(50) COLLATE utf8_bin DEFAULT NULL,
  `SemText` char(50) COLLATE utf8_bin DEFAULT NULL,
  `CurWorkId` char(50) COLLATE utf8_bin DEFAULT NULL,
  `SemWorkId` char(50) COLLATE utf8_bin DEFAULT NULL,
  `CurName` char(50) COLLATE utf8_bin DEFAULT NULL,
  `SemName` char(50) COLLATE utf8_bin DEFAULT NULL,
  `Descript` char(50) COLLATE utf8_bin DEFAULT NULL,
  `EntryDate` date DEFAULT NULL,
  PRIMARY KEY (`DBID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
CREATE TABLE IF NOT EXISTS `bgu_tripmain` (
  ...
  `ExceedValue` int(11) DEFAULT NULL,
  `OverChoice` char(5) COLLATE utf8_bin DEFAULT NULL,
  `Accumulate` int(11) DEFAULT NULL,
