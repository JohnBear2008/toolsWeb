...
CREATE TABLE IF NOT EXISTS `bgu_expdetail` (
  ...
  `Realtotal` char(20) COLLATE utf8_bin DEFAULT NULL,
...
-- 数据导出被取消选择。
-- 导出  表 toolsweb.bgu_expmain 结构
DROP TABLE IF EXISTS `bgu_expmain`;
CREATE TABLE IF NOT EXISTS `bgu_expmain` (
  `DBID` int(11) NOT NULL AUTO_INCREMENT,
  ...
  `RealValue` char(50) COLLATE utf8_bin DEFAULT NULL,
  `Currency` char(5) COLLATE utf8_bin DEFAULT NULL,
  `Payment` char(20) COLLATE utf8_bin DEFAULT NULL,
  `Explanation` varchar(500) COLLATE utf8_bin DEFAULT NULL,
  `BillStatus` char(10) COLLATE utf8_bin DEFAULT NULL,
  `Transaction` char(5) COLLATE utf8_bin DEFAULT NULL,
  `EntryDate` date DEFAULT NULL,
  PRIMARY KEY (`DBID`),
