...
//    console.log("get:"+JSON.stringify(sender.req.query));
 ...
 sql="INSERT INTO hmiprint_moni (Manufacturer,CtrlType,MachType,DDKey,CN,TW,EN,Visible) VALUES (?,?,?,?,?,?,?,?)";
    
    yjDBService.exec({
        sql : sql,
        parameters : [Manufacturer,CtrlType,MachType,DDKey,CN,TW,EN,Visible],
