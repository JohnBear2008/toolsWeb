module.exports = function (sender) {
	...
	var SQLExecute =
 		"  SELECT  A.DBID ,tbf.Design_Spec, tbf.Design_Name,  A.`Parts_Year`, A.`Parts_Rule`,  A.`Parts_Class`, A. `Parts_Apply_Date`,  A.`Parts_Limit_Date`,  A.`Parts_Name`,  " +
		...
		" `FEATURE20`  FROM `eng_imp_parts` A LEFT JOIN `auto_feature` tbf  on A.Parts_Class= tbf.Parts_Class  ";
      //    `auto_parts`
	//where A.Parts_Class=? 
