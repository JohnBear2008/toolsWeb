module.exports = function(sender) {
    ...
    var oldBILLID=sender.req.query.BILLID;
    ...
    var Partsstatus = sender.req.query.Partsstatus;  //0
    ...
    var PartsCode=PartsYearBF+PartsClass+'-'+PartsRuleBF+CodeDate+'-'+SupplyID;
    ...
    if(PartsClass=='R1' || PartsClass=='R2'|| PartsClass=='R3' ){
        PartsCode=PartsYearBF+PartsClass+'-'+PartsRuleBF+CodeDate+'-'+Soft_No;
    }
    // console.log('SND:'+ SMTID," 台头： ",SMTTitle," 供应 ",Soft_No,SupplyID+SupplyTitle+PartsOldCode+PartsName+'属'+PartsYear +PartsRuleBF+PartsClass+Soft_No );
    console.log('申请'+ PartsCode);
    //  console.log('暂时编码:', CodeDate);
     console.log('李真率:', Pattern);
    var sql="INSERT INTO auto_rec_parts (`BILL_ID`, `Parts_Year`, `Parts_Rule`, `Parts_Class`, `Parts_Chi` , `Model` , `Assembly` , `PartsUnitE`, `PhaseStatus` , " +
            " `UsePriority` , `Reason` ,`Parts_Apply_Date`, `Parts_Name`, `Parts_status`,  `Pattern` ,`Source` , `Staff`, `Property`, `Parts_Code`, `Supply_ID`,  `Supply_Title`, `SMT_ID`,  `SMT_Title` , `Parts_Old_Code` , "+
            ...
            function PrevDraft() {
                ...
                console.log( "娜恩",oldBILLID);
                yjDBService.exec({
                   sql: SQLDelete,
                   parameters: [oldBILLID], 
            ...
            function saveDraft() {
                yjDBService.exec({
                    sql : sql,
                    parameters : [BILLID, PartsYear, PartsRule, PartsClass, PartsChi , Model, Assembly , PartsUnitE, PhaseStatus , UsePriority , 
                    Reason ,PartsApplyDate,  PartsName, Partsstatus, Pattern , Source ,Staff, Property, PartsCode, SupplyID, SupplyTitle , SMTID , SMTTitle ,PartsOldCode,
                    Parts_Prop1,  Parts_Prop2, Parts_Prop3, Parts_Prop4, Parts_Prop5,Parts_Prop6, Parts_Prop7, Parts_Prop8, Parts_Prop9, Parts_Prop10,
                    Parts_Prop11, Parts_Prop12, Parts_Prop13, Parts_Prop14, Parts_Prop15, Parts_Prop16, Parts_Prop17, Parts_Prop18, Parts_Prop19, Parts_Prop20 ,Soft_No  ],
                    rowsAsArray : true,
                    success : function(result) {
