...
module.exports = function (sender) {
	...
	function HandleRecord(SQLExecute) {
		...
		if (resultCheckSQL) {
			...
			yjDBService.exec({
				...
				//  [
				// PropList[0], PropList[1], PropList[2], PropList[3], PropList[4], PropList[5],
				// PropList[6], PropList[7], PropList[8], PropList[9], PropList[10],
				// PropList[11], PropList[12], PropList[13], PropList[14], PropList[15],
				// PropList[16], PropList[17], PropList[18], PropList[19]
			      // ],
				rowsAsArray: false,
				success: function (data) {
					...
					for (var i = 0; i < data.length; i++) {
						...
						var obj = {
							...
							"Combo_Staff": data[i].Combo_Staff,
	...
	function HandleMe(i, result) {
		...
		var obj = {
			...
			"Name1":  ((result[i].Parts_Prop1  == '缺省' || result[i].Parts_Prop1  == null ||result[i].Parts_Prop1 == undefined) ? ('') : result[i].Parts_Prop1),
			"Name2":  ((result[i].Parts_Prop2  == '缺省' || result[i].Parts_Prop2  == null ||result[i].Parts_Prop2 == undefined) ? ('') : result[i].Parts_Prop2),
			"Name3":  ((result[i].Parts_Prop3  == '缺省' || result[i].Parts_Prop3  == null ||result[i].Parts_Prop3 == undefined) ? ('') : result[i].Parts_Prop3),
			"Name4":  ((result[i].Parts_Prop4  == '缺省' || result[i].Parts_Prop4  == null ||result[i].Parts_Prop4 == undefined) ? ('') : result[i].Parts_Prop4),
			"Name5":  ((result[i].Parts_Prop5  == '缺省' || result[i].Parts_Prop5  == null ||result[i].Parts_Prop5 == undefined) ? ('') : result[i].Parts_Prop5),
			"Name6":  ((result[i].Parts_Prop6  == '缺省' || result[i].Parts_Prop6  == null ||result[i].Parts_Prop6 == undefined) ? ('') : result[i].Parts_Prop6),
			"Name7":  ((result[i].Parts_Prop7  == '缺省' || result[i].Parts_Prop7  == null ||result[i].Parts_Prop7 == undefined) ? ('') : result[i].Parts_Prop7),
			"Name8":  ((result[i].Parts_Prop8  == '缺省' || result[i].Parts_Prop8  == null ||result[i].Parts_Prop8 == undefined) ? ('') : result[i].Parts_Prop8),
			"Name9":  ((result[i].Parts_Prop9  == '缺省' || result[i].Parts_Prop9  == null ||result[i].Parts_Prop9 == undefined) ? ('') : result[i].Parts_Prop9),
			"Name10": ((result[i].Parts_Prop10 == '缺省' || result[i].Parts_Prop10 == null ||result[i].Parts_Prop10 == undefined) ? ('') : result[i].Parts_Prop10),
			"Name11": ((result[i].Parts_Prop11 == '缺省' || result[i].Parts_Prop11 == null ||result[i].Parts_Prop11 == undefined) ? ('') : result[i].Parts_Prop11),
			"Name12": ((result[i].Parts_Prop12 == '缺省' || result[i].Parts_Prop12 == null ||result[i].Parts_Prop12 == undefined) ? ('') : result[i].Parts_Prop12),
			"Name13": ((result[i].Parts_Prop13 == '缺省' || result[i].Parts_Prop13 == null ||result[i].Parts_Prop13 == undefined) ? ('') : result[i].Parts_Prop13),
			"Name14": ((result[i].Parts_Prop14 == '缺省' || result[i].Parts_Prop14 == null ||result[i].Parts_Prop14 == undefined) ? ('') : result[i].Parts_Prop14),
			"Name15": ((result[i].Parts_Prop15 == '缺省' || result[i].Parts_Prop15 == null ||result[i].Parts_Prop15 == undefined) ? ('') : result[i].Parts_Prop15),
			"Name16": ((result[i].Parts_Prop16 == '缺省' || result[i].Parts_Prop16 == null ||result[i].Parts_Prop16 == undefined) ? ('') : result[i].Parts_Prop16),
			"Name17": ((result[i].Parts_Prop17 == '缺省' || result[i].Parts_Prop17 == null ||result[i].Parts_Prop17 == undefined) ? ('') : result[i].Parts_Prop17),
			"Name18": ((result[i].Parts_Prop18 == '缺省' || result[i].Parts_Prop18 == null ||result[i].Parts_Prop18 == undefined) ? ('') : result[i].Parts_Prop18),
			"Name19": ((result[i].Parts_Prop19 == '缺省' || result[i].Parts_Prop19 == null ||result[i].Parts_Prop19 == undefined) ? ('') : result[i].Parts_Prop19),
			"Name20": ((result[i].Parts_Prop20 == '缺省' || result[i].Parts_Prop20 == null ||result[i].Parts_Prop20 == undefined) ? ('') : result[i].Parts_Prop20),
			"ValueP": ('制造商'),
	...
	function AddPropAry() {
		...
		if (PropList[13] != "" && PropList[13] != "null" && PropList[13] != "缺省" && PropList[13] != undefined && PropList[13].length > 1) {
			SQLExecute = SQLExecute + " and A.Parts_Prop14= ? ";
			console.log("罡精:" + PropList[13]);
		}
		if (PropList[14] != "" && PropList[14] != "null" && PropList[14] != "缺省" && PropList[14] != undefined && PropList[14].length > 1) {
			SQLExecute = SQLExecute + " and A.Parts_Prop15= ? ";
			console.log("罡精:" + PropList[14]);
		}
		if (PropList[15] != "" && PropList[15] != "null" && PropList[15] != "缺省" && PropList[15] != undefined && PropList[15].length > 1) {
			SQLExecute = SQLExecute + " and A.Parts_Prop16= ? ";
			console.log("罡精:" + PropList[15]);
		}
		if (PropList[16] != "" && PropList[16] != "null" && PropList[16] != "缺省" && PropList[16] != undefined && PropList[16].length > 1) {
			SQLExecute = SQLExecute + " and A.Parts_Prop17= ? ";
			console.log("罡精:" + PropList[16]);
		}
		if (PropList[17] != "" && PropList[17] != "null" && PropList[17] != "缺省" && PropList[17] != undefined && PropList[17].length > 1) {
			SQLExecute = SQLExecute + " and A.Parts_Prop18= ? ";
			console.log("罡精:" + PropList[17]);
		}
		if (PropList[18] != "" && PropList[18] != "null" && PropList[18] != "缺省" && PropList[18] != undefined && PropList[18].length > 1) {
			SQLExecute = SQLExecute + " and A.Parts_Prop19= ? ";
			console.log("罡精:" + PropList[18]);
		}
		if (PropList[19] != "" && PropList[19] != "null" && PropList[19] != "缺省" && PropList[19] != undefined && PropList[19].length > 1) {
			SQLExecute = SQLExecute + " and A.Parts_Prop20= ? ";
			console.log("罡精:" + PropList[19]);
		}
