module.exports = function (sender) {
  ...
  function HandleParts(param1, param2) {
     var paramREP = '';
     var SQL = '';
     let SQL1 = "select  `Parts_Year`, `Parts_Rule`, `Parts_Class`, `Parts_Apply_Date`, `Parts_Limit_Date`, `Parts_Name`,  `Parts_Old_Name` , `Parts_Chi`, `Model` , `Assembly` , `PartsUnitE` , `PhaseStatus` , `UsePriority` , `Staff` , `Parts_Apply_Date` ,`Parts_Code`, `PID`, `Supply_ID` , `SMT_ID` , `Parts_Old_Code` ," +
     ...
     let SQL2 = "select  `Parts_Year`, `Parts_Rule`, `Parts_Class`, `Parts_Apply_Date`, `Parts_Limit_Date`, `Parts_Name`, `Parts_Old_Name` , `Parts_Chi`, `Model` , `Assembly`  ,`PartsUnitE` , `PhaseStatus` , `UsePriority` , `Staff` , `Parts_Apply_Date`  ,`Parts_Code`, `PID`,`Supply_ID` , `SMT_ID` , `Parts_Old_Code` ," +
        "`Parts_Prop1`,  `Parts_Prop2`, `Parts_Prop3`, `Parts_Prop4`, `Parts_Prop5`,`Parts_Prop6`, `Parts_Prop7`, `Parts_Prop8`, `Parts_Prop9`, `Parts_Prop10`, " +
        " `Parts_Prop11`, `Parts_Prop12`, `Parts_Prop13`, `Parts_Prop14`, `Parts_Prop15`, `Parts_Prop16`, `Parts_Prop17`, `Parts_Prop18`, `Parts_Prop19`, `Parts_Prop20` , `Soft_No`  " +
   ...
   //   console.log(" 起动SQL:" + SQL);
     console.log(" 再修改 :" + paramREP);
     yjDBService.exec({
        sql: SQL,
        parameters: [paramREP],
        rowsAsArray: false,
        success: function (result) {
           // console.log("饿了没",JSON.stringify(result)); 
           var obj = {};
           if (result[0] != undefined  ) {
              console.log("扩展模", (result[0].length)); 
              obj = { 
                 "status": "OK",
                 ...
                 "parts_old_name": result[0].Parts_Old_Name,
           ...
           if (dump.length > 100) {
             console.log("按可:" + dump.substring(50, 100));
           } else {
             console.log("按可:" + JSON.stringify(obj));
           }
        },
        error: sender.error
     });
