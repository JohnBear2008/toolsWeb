...
module.exports = function (sender) {
    ...
    function saveRule() {
        ...
        function FunOrig(cb) {
            ...
            var BodWorkId = '';
            var BodName = '';
            console.log(" 遛伊 ", OppWorkId," 遛伊 ", OppName);
            yjDBService.exec({
                sql: SQL3,
    ...
    function saveMain() {
        let paramList = [BillNo, ApplicNo, Subject , Version, BusiMan, BusiArea, DeptName,
        ...
        var SQLInsert = "INSERT INTO `bgu_tripmain` (   `BillNo`  ,  `ApplicNo`  , `Subject`  ,  `Version`  ,  `BusiMan`  ,  `BusiArea`  ,  `DeptName`  , " +
            " `StaffID`  ,  `StaffName`  ,  `LeaveDate`  , `LeaveHour`  ,  `LeaveMin`  ,  `BackDate`  , " +
            " `BackHour`  ,  `BackMin`  ,  `LiveDateA`  ,  `LiveDateB`  ,  `LiveDateC`  ,  `LiveDateD`  , " +
            " `LiveDateE`  ,  `LiveDateF`  ,  `Explanation`  ,  `Overspend`  ,  `IsOver`  ,  `HotelName`  , " +
            " `HotelTel`  ,  `EntryDate`  ,  `BillStatus`    ) " +
