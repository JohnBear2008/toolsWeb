//ExSubB.js
function HuwaiB(  BillNo ,SNNO) {
    var reportType = 'NatureTrip';
    var arrange = 'popup';
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            var CompMan = bjob[21].CompMan;
            var RoomChoice = bjob[21].RoomChoice;
            var DinnerChoice = bjob[21].DinnerChoice;
            console.log("也从1苏醒", CompMan,"也从2苏醒", RoomChoice,"也从3苏醒", DinnerChoice);
            $('#listPrintViewDiv').html('');
            htmlModel = '' +
        '<div id=\'waterAy\' style="left:200px;top:0px;width:950px;height:500px;">' +
        '<table width="1000" border="3" border = "1" > ' +
        '  <tr> ' +
        '    <td width="50" colspan="8"  height="30" align="center"  > ' +
        '      <h3>国内外出差申请汇总及补贴申请表<font face="arial" color="darkgray">OrigName</font></h3> ' +
        '    </td> ' +
        ...
        '  </tr> ' +
        '  <tr> ' +
        '    <td width="50" bgcolor="#FAF0E6" colspan="2" height="25">表单编号 ApplicNo  </td> ' +
        '    <td width="50" bgcolor="#FAF0E6" colspan="2" height="25">部門 DeptName </td> ' +
        '    <td width="50" bgcolor="#FAF0E6" colspan="2" height="25">出差人 BusiMan </td> ' +
        '    <td width="50" bgcolor="#FAF0E6" colspan="2" height="25">同行人 CompMan  </td> ' +
        '    <td width="50"  bgcolor="#FAF0E6" align="center" colspan="1" height="30"><img src="watermark"  /> </td> ' +
        '  </tr> ' +
        '  <tr> ' +
        '    <td width="50" bgcolor="#FAF0E6" colspan="4" height="25">出差地区：BusiArea   </td> ' +
        '    <td width="50" bgcolor="#FAF0E6" colspan="2" height="25">住房选择：RoomChoice </td> ' +
        '    <td width="50" bgcolor="#FAF0E6" colspan="3" height="25">餐费选择：DinnerChoice </td> ' +
        '  </tr> ' +
        '  <tr> ' +
        ...
        '   <td width="50" height="25">LiveDateA LiveExtA </td>' +
        '   <td width="50" height="25">LiveDateB LiveExtB </td>' +
        '   <td width="50" height="25">LiveDateC LiveExtC </td>' +
        '   <td width="50" height="25">LiveDateD LiveExtD </td>' +
        '   <td width="50" height="25">LiveDateE LiveExtE </td>' +
        '   <td width="50" height="25">LiveDateF LiveExtF </td>' +
        ...
        '   <td width="50" height="25" class="fee-approval">TicTotal_14</td>' +
        ...
        '  </tr> ' +
            ...
            for (let i = 20; i < 21; i++) {
                console.log( "夏目" ,bjob[i].CompMan); 
                console.log( "夏目" ,bjob[i].RoomChoice); 
                console.log( "夏目" ,bjob[i].DinnerChoice); 
                var objU = {
                    "BillNo": bjob[i].BillNo,
                    "ApplicNo": bjob[i].ApplicNo,
                    "Version": bjob[i].Version,
                    "BusiMan": bjob[i].BusiMan,
                    "CompMan": bjob[i].CompMan,
                    "BusiArea": bjob[i].BusiArea,
                    "RoomChoice": bjob[i].RoomChoice,
                    "DinnerChoice": bjob[i].DinnerChoice,
            ...
            var fillPrintModel = ({
                ...
                BillNo   ,   ApplicNo   ,   Version   ,   BusiMan   , CompMan ,    BusiArea  ,  
                RoomChoice  ,  DinnerChoice,  DeptName   ,TotalValue ,
                ...
                StatusOK, Accumulate , Surplus , DivideValue, UpperLimit,
                }) => {
                ...
                .replace(/CompMan/, CompMan )   
                .replace(/BusiArea/, BusiArea )   
                .replace(/RoomChoice/, RoomChoice )   
                .replace(/DinnerChoice/, DinnerChoice )   
                ...
                .replace(/LiveExtA/, LiveExtA)  
                .replace(/LiveExtB/, LiveExtB)  
                .replace(/LiveExtC/, LiveExtC)  
                .replace(/LiveExtD/, LiveExtD)  
                .replace(/LiveExtE/, LiveExtE)  
                .replace(/LiveExtF/, LiveExtF)  
                ...
                if (sData.length > 0) {
                    ...
                    for (let i = 0; i < sData.length; i++) { //sData.length 会重复累加视窗
                        ...
                        newHtml = fillPrintModel({
                            ...
                            CompMan:   sData[20].CompMan,  
                            BusiArea:   sData[20].BusiArea,  
                            RoomChoice:   sData[20].RoomChoice,  
                            DinnerChoice:   sData[20].DinnerChoice,  
                            DeptName:   sData[20].DeptName,  
                            TotalValue:   sData[20].TotalValue,  
                            ...
                            LiveExtA:   sData[20].LiveExtA,  
                            LiveExtB:   sData[20].LiveExtB,  
                            LiveExtC:   sData[20].LiveExtC,  
                            LiveExtD:   sData[20].LiveExtD,  
                            LiveExtE:   sData[20].LiveExtE,  
                            LiveExtF:   sData[20].LiveExtF,  
                            ...
                            OrigName: sData[21].OrigName,

                            Accumulate : sData[22].Accumulate,
                            Surplus: sData[22].Surplus,
                            DivideValue: sData[22].DivideValue,
                            UpperLimit: sData[22].UpperLimit,
