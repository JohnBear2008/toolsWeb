function DryingA(BillNo) {
    var reportType = 'WeeeklyPay';
    var arrange = 'popup';
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            htmlModel = '' +
                ...
                '<td width="50" height="25">RealTot_1</td>' +
                ...
                '<td width="50" height="25">RealTot_2</td>' +
                ...
                '<td width="50" height="25">RealTot_3</td>' +
                ...
                '<td width="50" height="25">RealTot_4</td>' +
                ...
                '<td width="50" height="25">RealTot_5</td>' +
                ...
                '<td width="50" height="25">RealTot_6</td>' +
                ...
                '<td width="50" height="25">RealTot_7</td>' +
                ...
                '<td width="50" height="25">RealTot_8</td>' +
                ...
                '<td width="50" height="25">RealTot_9</td>' +
                ...
                '<td width="50" height="25">RealTot_10</td>' +
                ...
                // '<td width="50" rowspan="4"   colspan="2" height="25">  <br/>  ' +
                // '   <br/>  ' +
                // '   <br/>  ' +
                // '   <br/>  ' +
                // '   </td> ' +
                ...
                '</tr>' +
                '<tr>' +
                '<td width="50" colspan="2" height="25">发票金额</td>' +
                '<td width="50" colspan="2" height="25">RealV</td>' +
                '</tr>' +
                '<tr>' +
            ...
            var fillPrintModel = ({
                htmlModel,
                SNO_1, BudItem_1, ItemO_1, Descip_1, Measure_1, Invent_1, UniPrice_1, QuantAmt_1, SubTot_1, RealTot_1,  Delivway_1, Vender_1, Underbur_1, ApendType_1, DeptM_1,
                SNO_2, BudItem_2, ItemO_2, Descip_2, Measure_2, Invent_2, UniPrice_2, QuantAmt_2, SubTot_2, RealTot_2,  Delivway_2, Vender_2, Underbur_2, ApendType_2, DeptM_2,
                SNO_3, BudItem_3, ItemO_3, Descip_3, Measure_3, Invent_3, UniPrice_3, QuantAmt_3, SubTot_3, RealTot_3,  Delivway_3, Vender_3, Underbur_3, ApendType_3, DeptM_3,
                SNO_4, BudItem_4, ItemO_4, Descip_4, Measure_4, Invent_4, UniPrice_4, QuantAmt_4, SubTot_4, RealTot_4,  Delivway_4, Vender_4, Underbur_4, ApendType_4, DeptM_4,
                SNO_5, BudItem_5, ItemO_5, Descip_5, Measure_5, Invent_5, UniPrice_5, QuantAmt_5, SubTot_5, RealTot_5,  Delivway_5, Vender_5, Underbur_5, ApendType_5, DeptM_5,
                SNO_6, BudItem_6, ItemO_6, Descip_6, Measure_6, Invent_6, UniPrice_6, QuantAmt_6, SubTot_6, RealTot_6,  Delivway_6, Vender_6, Underbur_6, ApendType_6, DeptM_6,
                SNO_7, BudItem_7, ItemO_7, Descip_7, Measure_7, Invent_7, UniPrice_7, QuantAmt_7, SubTot_7, RealTot_7,  Delivway_7, Vender_7, Underbur_7, ApendType_7, DeptM_7,
                SNO_8, BudItem_8, ItemO_8, Descip_8, Measure_8, Invent_8, UniPrice_8, QuantAmt_8, SubTot_8, RealTot_8,  Delivway_8, Vender_8, Underbur_8, ApendType_8, DeptM_8,
                SNO_9, BudItem_9, ItemO_9, Descip_9, Measure_9, Invent_9, UniPrice_9, QuantAmt_9, SubTot_9, RealTot_9,  Delivway_9, Vender_9, Underbur_9, ApendType_9, DeptM_9,
                SNO_10, BudItem_10, ItemO_10, Descip_10, Measure_10, Invent_10, UniPrice_10, QuantAmt_10, SubTot_10,  RealTot_10, Delivway_10, Vender_10, Underbur_10, ApendType_10, DeptM_10,
                Bill_No, List_No, ReqDate, Proj_No, Applic_No, GroupName, TotalV, RealV, Exchange, Pay_method, Explan, Entry_Date,
                ...
                let newHtml = htmlModel
                    ...
                    .replace(/SubTot_1/, SubTot_1)    
                    .replace(/SubTot_2/, SubTot_2)    
                    .replace(/SubTot_3/, SubTot_3)    
                    .replace(/SubTot_4/, SubTot_4)    
                    .replace(/SubTot_5/, SubTot_5)    
                    .replace(/SubTot_6/, SubTot_6)    
                    .replace(/SubTot_7/, SubTot_7)    
                    .replace(/SubTot_8/, SubTot_8)    
                    .replace(/SubTot_9/, SubTot_9)    
                    .replace(/SubTot_10/, SubTot_10)  

					.replace(/RealTot_1/, RealTot_1)   .replace(/Delivway_1/, Delivway_1)
                    .replace(/RealTot_2/, RealTot_2)   .replace(/Delivway_2/, Delivway_2)
                    .replace(/RealTot_3/, RealTot_3)   .replace(/Delivway_3/, Delivway_3)
                    .replace(/RealTot_4/, RealTot_4)   .replace(/Delivway_4/, Delivway_4)
                    .replace(/RealTot_5/, RealTot_5)   .replace(/Delivway_5/, Delivway_5)
                    .replace(/RealTot_6/, RealTot_6)   .replace(/Delivway_6/, Delivway_6)
                    .replace(/RealTot_7/, RealTot_7)   .replace(/Delivway_7/, Delivway_7)
                    .replace(/RealTot_8/, RealTot_8)   .replace(/Delivway_8/, Delivway_8)
                    .replace(/RealTot_9/, RealTot_9)   .replace(/Delivway_9/, Delivway_9)
                    .replace(/RealTot_10/, RealTot_10) .replace(/Delivway_10/, Delivway_10)
                ...
                if (sData.length > 0) {
                    ...
                    for (let i = 0; i < sData.length; i++) {
                        ...
                        newHtml = fillPrintModel({
                            ...
                            SubTot_1: sData[0].SubTot,  
                            SubTot_2: sData[1].SubTot,  
                            SubTot_3: sData[2].SubTot,  
                            SubTot_4: sData[3].SubTot,  
                            SubTot_5: sData[4].SubTot,  
                            SubTot_6: sData[5].SubTot,  
                            SubTot_7: sData[6].SubTot,  
                            SubTot_8: sData[7].SubTot,  
                            SubTot_9: sData[8].SubTot,  
                            SubTot_10: sData[9].SubTot, 
                            
                            RealTot_1: sData[0].RealTot, Delivway_1: sData[0].Delivway,
                            RealTot_2: sData[1].RealTot, Delivway_2: sData[1].Delivway,
                            RealTot_3: sData[2].RealTot, Delivway_3: sData[2].Delivway,
                            RealTot_4: sData[3].RealTot, Delivway_4: sData[3].Delivway,
                            RealTot_5: sData[4].RealTot, Delivway_5: sData[4].Delivway,
                            RealTot_6: sData[5].RealTot, Delivway_6: sData[5].Delivway,
                            RealTot_7: sData[6].RealTot, Delivway_7: sData[6].Delivway,
                            RealTot_8: sData[7].RealTot, Delivway_8: sData[7].Delivway,
                            RealTot_9: sData[8].RealTot, Delivway_9: sData[8].Delivway,
                            RealTot_10: sData[9].RealTot, Delivway_10: sData[9].Delivway,
