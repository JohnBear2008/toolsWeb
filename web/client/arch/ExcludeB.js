        ...
        success: function (data) {
          ...
          //   console.log("端装", json2, "机动", data.length);
            for (var i = 0; i < dataArr.length; i++) {
                ...
                emdata.push(dataTTT);
              //   $("#TripViewBtn").addClass("layui-btn layui-btn-danger layui-btn");
            }
            ...
            table.render({
                ...
                , cols: [[
                  //   { type: 'checkbox', fixed: 'left' }
                    ...
                    , { field: 'ApplicNo', title: '申请单号', width: 90, sort: true, hide: true }
                    , { field: 'Subject', title: '科目', width: 80  }
                    , { field: 'DivideValue', title: '分批额', width: 80 }
            ...
            table.on('toolbar(baby)', function (obj) {
                objCenter = obj;
                ...
                switch (obj.event) {
                    case 'viewSumary':
                        ...
                        HuwaiB(dataARR[0].BillNo ,CapSNNO);
            ...
            table.on('tool(baby)', function (obj) {
                ...
                if (obj.event === 'analysis') {
                    ...
                    layer.confirm('进行审批同意吗，请确认操作是否无误？', {
                        ...
                        var taskData = {
                            "reportType": reportType, "BillNo": Parts_BillNo, "SNNO": SNNO, "Formkind": Formkind, "Subject": CapSubject,
                    ...
                    layer.confirm('进行审批驳回吗，请确认操作是否无误？', {
                        ...
                        var taskData = {
                            "reportType": reportType,  "arrange": arrange, "BillNo": Parts_BillNo, "SNNO": SNNO, "Subject": CapSubject,  "TotalValue": CapTotalValue,
