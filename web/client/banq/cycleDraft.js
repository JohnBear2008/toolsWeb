    ...
    $.ajax({
        ...
        success: function (dataArr) {
            for (var i = 0; i < dataArr.length; i++) {
                ...
                var arrange = 'submit';
                Partsstatus = '0';
                layer.confirm('提交此品名： ' + PartsName + '(tips:1.进入审批作业，可在新品编码审批中寻得。2.存成草稿，可在审批记录中寻得。3.取消:无操作)', {
                    btn: ['进入审批', '存成草稿', '取消'],
                    btn1: function () {
                        ...
                        var taskData = {
                            ...
                            "Parts_Prop11": Prop11, "Parts_Prop12": Prop12, "Parts_Prop13": Prop13, "Parts_Prop14": Prop14, "Parts_Prop15": Prop15,
                            "Parts_Prop16": Prop16, "Parts_Prop17": Prop17, "Parts_Prop18": Prop18, "Parts_Prop19": Prop19, "Parts_Prop20": Prop20,
                            "reportType": reportType, "arrange": arrange, "BILLID": BILLID, "PartsYear": PartsYear, "PartsRule": PartsRule, "PartsClass": PartsClass, "PartsChi": PartsChi,
                            "Model": Model, "Assembly": Assembly,   "UnitE": UnitE, "Phase": Phase, "Priority": Priority, "Reason": Reason,
                            "PartsApplyDate": PartsApplyDate, "PartsLimitDate": PartsLimitDate, "PartsName": PartsName, "Partsstatus": Partsstatus,  "Pattern": Pattern, "Staff": Staff,
                            "Property": Property, "SupplyID": SupplyID, "SupplyTitle": SupplyTitle,
                    ...
                    btn2: function () {
                        ...
                        var taskData = {
                            ...
                            "reportType": reportType, "arrange": arrange, "BILLID": BILLID, "PartsYear": PartsYear, "PartsRule": PartsRule, "PartsClass": PartsClass, "PartsChi": PartsChi, 
                            "Model": Model, "Assembly": Assembly,  "UnitE": UnitE, "Phase": Phase, "Priority": Priority, "Reason": Reason,
                            "PartsApplyDate": PartsApplyDate, "PartsLimitDate": PartsLimitDate, "PartsName": PartsName, "Partsstatus": Partsstatus, "Pattern": Pattern,
                            "Staff": Staff, "Property": Property, "SupplyID": SupplyID, "SupplyTitle": SupplyTitle, "SMTID": SMTID, "SMTTitle": SMTTitle, 
                            "PartsOldCode": PartsOldCode
                        }
                        $.ajax({
                            method: 'post',
                            data: taskData,
