...
function ReferCargo(drawer) {
    ...
    if (SPecNamecheck(PartsName, "品名")) {

    } else {
        layer.alert("品名不对，请检查!");
        return;
    }
    console.log("园田..... ",Partsstatus);
    var reportType = 'submitSupp';
    var taskData = {
        "Parts_Prop1": Prop1, "Parts_Prop2": Prop2, "Parts_Prop3": Prop3, "Parts_Prop4": Prop4, "Parts_Prop5": Prop5,
        "Parts_Prop6": Prop6, "Parts_Prop7": Prop7, "Parts_Prop8": Prop8, "Parts_Prop9": Prop9, "Parts_Prop10": Prop10,
        "Parts_Prop11": Prop11, "Parts_Prop12": Prop12, "Parts_Prop13": Prop13, "Parts_Prop14": Prop14, "Parts_Prop15": Prop15,
        ...
        "PartsChi": PartsChi, "Model": Model, "Assembly": Assembly,  "UnitE": UnitE, "Phase": Phase, "Priority": Priority, "Reason": Reason, 
        "PartsApplyDate": PartsApplyDate, "PartsLimitDate": PartsLimitDate, "PartsName": PartsName, "Partsstatus": Partsstatus, 
        "Pattern": Pattern,"Staff": Staff, "Property": Property, "Soft_No": Soft_No, "PID": PID, "SupplyID": SupplyID, "SupplyTitle": SupplyTitle, "SMTID": SMTID, "SMTTitle": SMTTitle,
        "PartsOldCode": PartsOldCode, "PartsCode": PartsCode
    }
    layer.confirm("提交此品名： " + PartsName  +"<br></br>", {
        btn: ['是', '否'] //按钮
    }, function () {
        $.ajax({
        method: 'post',
    ...
    // active.confirmTrans("提交此品名： " + PartsName + "<br></br>");
