...
var yjSecurity = {
	...
	*/
	...
	"Diffie-Hellman" : {
		 ...
		 */
		sign : function(str) {
			var encoder = new NodeRSA(yjDiffieHellman.privateKey_pkcs1,{encryptionScheme: 'pkcs1'});
		...
		verify : function(str, signature) {
			var decoder = new NodeRSA(yjDiffieHellman.publicKey_pkcs8,{encryptionScheme: 'pkcs1'});
